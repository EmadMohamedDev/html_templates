...
.vjs-default-skin .vjs-big-play-button {
    background: -webkit-linear-gradient(left, #e2e42a, #bfc135) !important;
}
</style>
...
<div id="second_modal">
    ...
    <div class="content">
        ...
        <div class="body">
            ...
            <iframe id="map" src="http://127.0.0.1/alafasy_web_app_v3/38/nearestMosqueMap" width="600" height="350"
