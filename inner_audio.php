                ...
                <div class="col-12">
                    <section class="inner-img text-center">
                        ...
                        <div class="audio-player">
                            <audio id="player" src="img/اللهم ارزقنا رزقاً يزيدنا لك شكرا.mp3"
                                onended="myFunction()"></audio>
                    ...
                    <div class="btn-download text-center rounded">
                        <a href="img/اللهم ارزقنا رزقاً يزيدنا لك شكرا.mp3" class="btn border-0"
                            download="اللهم أبسط على والدي من بركاتك">تحميل</a>
                    </div>
                </div>
            </div>
        </div>
