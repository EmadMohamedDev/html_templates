            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-img" role="tabpanel" aria-labelledby="pills-img-tab">
                    <div class="head-title">
                        <h5 class="text-center">الجديد من الصور</h5>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-audio" role="tabpanel" aria-labelledby="pills-audio-tab">
                    <div class="head-title">
                        <h5 class="text-center">الجديد من صوتيات</h5>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-waiting" role="tabpanel" aria-labelledby="pills-waiting-tab">
                    <div class="head-title">
                        <h5 class="text-center">الجديد من أدعية الانتظار</h5>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab">
                    <div class="head-title">
                        <h5 class="text-center">الجديد من الفيديو</h5>
                    </div>
